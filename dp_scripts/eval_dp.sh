...
CKPT=/N/u/mihparek/BigRed200/robocasa_diffusion_policy/data/outputs/2026.09.07/02.45.59_train_diffusion_transformer_hybrid_target_composite_seen/checkpoints/latest.ckpt
TASK=${1:-SearingMeat}
